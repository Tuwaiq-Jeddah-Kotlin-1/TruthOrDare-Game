...
class PlayFragment : Fragment() {  //, View.OnClickListener
    ...
    private val selectedLanguage = "en"  //Locale.getDefault().displayLanguage
    ...
    private fun retrieveGameData(view: View) {
            ...
            override fun onTick(millis: Long) {
                val hms = String.format(
                    ...
                    TimeUnit.MILLISECONDS.toMinutes(millis) - TimeUnit.HOURS.toMinutes(
                        TimeUnit.MILLISECONDS.toHours(millis)), TimeUnit.MILLISECONDS.toSeconds(millis) -
        ...
        if (vm.checkConnection(view.context)) {
            vm.dataList(view.context).observe(viewLifecycleOwner, { it ->
